        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Tu paquete llegará en un plazo de 3 a 5 días laborables a tu punto
              de recogida o a la comodidad de tu hogar.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ¿No te queda bien? No te preocupes: te lo cambiamos por uno nuevo.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ...
              Sin preguntas: haremos todo lo posible para que su devolución sea
              sin complicaciones.
            </p>
          </div>
        </div>
